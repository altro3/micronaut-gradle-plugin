    ...
    public void execute() {
        ...
        var builder = MicronautCodeGeneratorEntryPoint.builder()
            ...
            .withOptions(options -> options
                ...
                .withSerializationLibrary(SerializationLibraryKind.valueOf(parameters.getSerializationFramework().get().toUpperCase(Locale.ENGLISH)))
                ...
                .withDateTimeFormat(MicronautCodeGeneratorOptionsBuilder.DateTimeFormat.valueOf(parameters.getDateTimeFormat().get().toUpperCase(Locale.ENGLISH)))
